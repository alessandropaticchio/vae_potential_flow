...
torch.save(rays_train_set, img_path + 'rays_pic_data_1224_20/training_rays.pt')
torch.save(rays_test_set, img_path + 'rays_pic_data_1224_20/test_rays.pt')
torch.save(potential_train_set, img_path + 'potential_pic_data_1224_20/training_potential.pt')
torch.save(potential_test_set, img_path + 'potential_pic_data_1224_20/test_potential.pt')
